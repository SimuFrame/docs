...
# Definir a discretização dos elementos (manter 1 para treliças espaciais)
n = 1
...
if caso == 1:
    ...
    estrutura = Estrutura('Treliça 1', modelo, coord, conec, n)
    ...
    # Criar os dados do elemento estrutural
    estrutura = Estrutura('Treliça 2', modelo, coord, conec, n)
    estrutura.definir_apoios(condicoes_contorno)
