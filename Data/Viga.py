...
def exemplo(analise, caso, n):
    if caso == 1:
        ...
        estrutura = Estrutura(analise, 'Varal (modelo de viga)', modelo, coord, conec, n)
        ...
        estrutura.geometria({
            range(len(conec)): {"geometria": "circular", "E": 2.7e7, "v": 0.3, "raio": 0.02},
        })
        ...
        # Criar os dados do elemento estrutural
        estrutura = Estrutura(analise, 'Viga (carga concentrada)', modelo, coord, conec, n)
        estrutura.definir_apoios(condicoes_contorno)
        ...
        estrutura.geometria({
            range(len(conec)): {"geometria": "retangular", "E": 2.7e3, "v": 0.2, "base": 0.20, "altura": 0.40},
        })
        ...
        # Criar os dados do elemento estrutural
        estrutura = Estrutura(analise, 'Viga em balanço', modelo, coord, conec, n)
        estrutura.definir_apoios(condicoes_contorno)
        ...
        # Criar os dados do elemento estrutural
        estrutura = Estrutura(analise, 'Viga biapoiada', modelo, coord, conec, n)
        estrutura.definir_apoios(condicoes_contorno)
